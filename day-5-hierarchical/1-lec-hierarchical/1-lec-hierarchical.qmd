...
- When you have predictor variables, $\{x_{i1}, \cdots, x_{ip}\}$; you can specify an observation specific mean:
\begin{equation*}
Y_i \mid \mu_i, \sigma \overset{ind}{\sim} \textrm{Normal}(\mu_i, \sigma^2), \,\,\, i = 1, \cdots, n,
\end{equation*}
where 
\begin{equation*}
