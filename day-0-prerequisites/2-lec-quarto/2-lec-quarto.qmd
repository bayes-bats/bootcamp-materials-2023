...
The slides you are looking at right now and the bootcamp schedule are all prepared using Quarto. 
The source code is available on our [GitHub organization](https://github.com/bayes-bats/bootcamp-material).
