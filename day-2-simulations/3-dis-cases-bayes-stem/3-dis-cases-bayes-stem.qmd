...
::: {.column width="40%"}
Beta(1,1) prior with 3 successes and 147 failures yields a Beta(1+3,1+47)=Beta(4,148) posterior, and the posterior mean estimate of the probability of a tumor in this group is $\frac{4}{148+4}=\frac{4}{152}=0.026$.
:::
...
-   Add your examples to LINK HERE

-   Split into (new!) groups of 4 and share your ideas
