...
We will first look at convergence diagnostics and assuming these are satisfactory, we will calculate the posterior probability that the mean difference between response times after 7 days and 1 day of sleep deprivation is $>0$.
